...
export class AddressClassifier {
   ...
   */
  private checkPDAPatterns(
    address: string,
    pubkey: PublicKey
  ): { isPDA: boolean; confidence: number; pattern?: string; info?: any } {
   ...
   */
  private async checkIfNFT(
    pubkey: PublicKey,
    accountInfo: any
  ): Promise<{ isNFT: boolean; tokenInfo?: any; nftInfo?: any }> {
    try {
