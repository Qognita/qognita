  ...
  return (
    <div className="w-full h-[400px]">
      ...
      <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
        <h4 className="text-sm font-semibold mb-2">Vesting Schedule Overview</h4>
        <p className="text-xs text-gray-600 dark:text-gray-400">
          This chart shows how tokens are released over time for each allocation category. 
          Gradual vesting helps prevent market dumps and aligns long-term incentives.
        </p>
      </div>
    </div>
  )
