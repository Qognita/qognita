...
async function analyzeTransaction(address: string, result: any) {
  ...
  try {
    ...
    result.transactionAnalysis = {
      ...
      isSuccessful: transactionAnalysis.riskFactors.length === 0 || !transactionAnalysis.riskFactors.includes('Transaction failed'),
...
async function fetchCompleteWalletData(address: string) {
  ...
  const mockData = {
    ...
    allTransactions: [
      {
        signature: '5VfYmGBjjTWetGrgm7sbiW6pxhdJEuZsHtr4k3BsBmig9Antm2hmmvBVAjM9ttjAPiV4nNEb3okBo6DhcGj5i75p',
        type: 'Transfer',
        amount: 0.5,
        token: 'SOL',
      ...
      {
        signature: '4VfYmGBjjTWetGrgm7sbiW6pxhdJEuZsHtr4k3BsBmig9Antm2hmmvBVAjM9ttjAPiV4nNEb3okBo6DhcGj5i74p',
        type: 'Token Transfer',
        amount: 1000,
        token: 'USDC',
      ...
      {
        signature: '3VfYmGBjjTWetGrgm7sbiW6pxhdJEuZsHtr4k3BsBmig9Antm2hmmvBVAjM9ttjAPiV4nNEb3okBo6DhcGj5i73p',
        type: 'Swap',
        amount: 100,
        token: 'RAY',
      ...
      {
        signature: '2VfYmGBjjTWetGrgm7sbiW6pxhdJEuZsHtr4k3BsBmig9Antm2hmmvBVAjM9ttjAPiV4nNEb3okBo6DhcGj5i72p',
        type: 'Buy',
        amount: 2.5,
        token: 'SOL',
      ...
      {
        signature: '1VfYmGBjjTWetGrgm7sbiW6pxhdJEuZsHtr4k3BsBmig9Antm2hmmvBVAjM9ttjAPiV4nNEb3okBo6DhcGj5i71p',
        type: 'Sell',
        amount: 500,
        token: 'USDC',
...
function addRisksAndRecommendations(report: string, risks: any[], trustScore: number | null): string {
